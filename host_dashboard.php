...
if (isset($_GET['status'])) {
    if ($_GET['status'] == 'edit_success') {
        ...
        echo '<div id="feedback-message" class="alert alert-success">Booking request rejected successfully! <br> We will reach the guest to give him his money back</div>';
    }
}
...
<div class="container mt-5">
    ...
    <div class="text-center mb-4">
        ...
        <a href="host_earnings_report.php?" class="btn btn-primary">generate Visual Report</a>
    </div>
